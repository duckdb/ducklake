...
string DuckLakeMetadataManager::WriteNewTableConfigOptions(const vector<DuckLakeConfigOption> &new_options) {
	...
	for (idx_t i = 0; i < new_options.size(); i++) {
		auto &opt = new_options[i];
